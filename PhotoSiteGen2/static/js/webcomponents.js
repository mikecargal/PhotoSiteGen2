...
class FadeInImage extends HTMLElement {
  ...
  masonrySizing() {
    if (!FadeInImage._masonrySizing) {
      ...
      const additionalSizing = `img {
         width: calc(((100vw - ${bodyMargin}px) / 2) - ${GUTTER});
       }
       @media screen and (min-width: ${cutoff3col}px) {img { width: calc(((100vw - ${bodyMargin}px) / 3) - ${GUTTER});}}
       @media screen and (min-width: ${cutoff4col}px) {img { width: calc(((100vw - ${bodyMargin}px) / 4) - ${GUTTER});}}
       @media screen and (min-width: ${cutoff5col}px) {img { width: calc(((100vw - ${bodyMargin}px) / 5) - ${GUTTER});}}
      `;
